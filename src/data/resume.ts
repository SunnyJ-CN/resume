...
export const projects: Project[] = [
  {
    ...
    highlights: [
      "负责需求评估、技术方案、架构设计、开发联调、测试跟进与 App Store 上架，覆盖移动端完整交付链路。",
      "建设 URL Scheme / Universal Link / 内部路由体系，支撑首页、轨迹、商城、福利与小程序等多入口跳转，并持续治理异常参数与基础 Tab 路由失效问题。",
      "落地 WidgetKit 小组件体系，处理 Token 自动刷新、UserDefaults 数据合并、登录/绑定状态防御与低版本 iOS 布局兼容。",
      "接入 LocalSendKit 与车机文件互传能力，补齐热点扫码连接、传输状态上报、网络环境变化重建和测试环境日志页，提升偶发问题定位效率。",
      "重构记录仪/远程监控直播逻辑，拆分播放器策略，补充生命周期监听、推流失败处理、全屏状态恢复和日志链路，增强直播场景稳定性。",
      "推进 D3D 车模与主题商城能力，完成素材下载解压、车牌生成、车模状态同步、SDK 日志接入 OSLog、资源体积优化和后台渲染暂停。",
      "优化商业化链路，包括开屏广告缓存策略、信息流广告、激励广告回调、广告 SDK 切换和埋点上报。",
